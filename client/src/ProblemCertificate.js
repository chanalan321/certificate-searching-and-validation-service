...
import ProblemCertificate_component from './ProblemCertificate_component';
...
export default function ProblemCertificate() {
  ...
  return (
    <div className={classes.root}>
      ...
      >
        ...
        <Divider />
        <List><Worker_upperlistItems/></List>
        <Divider />
        <List><Worker_lowerlistItems/></List>
      </Drawer>
